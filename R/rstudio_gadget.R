    ...
    miniUI::miniTabstripPanel(
      ...
      miniUI::miniTabPanel("R script",
        ...
        miniUI::miniContentPanel(
          ...
          shiny::textInput("rSchedule",
            label = "cron Schedule",
            value = "15 8 * * *"
          ),
          shiny::helpText("Set schedule to empty to run now"),
          shiny::textInput("rImage",
            label = "R docker image",
            value = "rocker/verse"
          ),
      ...
      miniUI::miniTabPanel("plumber API",
