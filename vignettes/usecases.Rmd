...
## Build an Rmd to HTML each git commit or schedule and host it on Cloud Storage
...
rmd_build <- cr_build_yaml(
  steps = cr_buildstep_r(
      ...
      r = "rmarkdown::render('scheduled_rmarkdown.Rmd', 
                             output_file = 'scheduled_rmarkdown.html')",
      name = "gcr.io/gcer-public/packagetools:master",
      dir = "inst/scheduled_rmarkdown/"
    ),
  artifacts = cr_build_yaml_artifact("inst/scheduled_rmarkdown/scheduled_rmarkdown.html", bucket = "mark-edmondson-public-read")
  )
...
The Rmd will build upon each commit
