...
r <- "rmarkdown::render('inst/scheduled_rmarkdown/scheduled_rmarkdown.Rmd')"

# script to setup nginx 
bash_script <- system.file("docker", "nginx", "setup.bash",
                           package = "googleCloudRunner")

repo_source <- cr_build_source(RepoSource("github_markedmondson1234_googlecloudrunner",
                          branchName = ".*",
                          projectId = cr_project_get()))
                          
build_me <- cr_build_make(cr_build_yaml(
      steps = c(
          cr_buildstep_r(r,
                  name = r_image,
                  dir = rmd_folder,
