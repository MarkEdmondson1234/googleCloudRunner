...
As you update the code in `app.R` and push to GitHub, the build trigger builds the Docker image and publishes it to the kubernetes cluster.  The docker is built using kamiko cache, which speeds up repeat builds and deployments.
