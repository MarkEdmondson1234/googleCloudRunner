...
Via [Cloud Scheduler](https://code.markedmondson.me/googleCloudRunner/articles/cloudscheduler.html) you can set up a scheduled hit of your HTTP endpoints, via GET, POST or any other methods you have coded into your app.  `cr_run_schedule_http()` will help you create the HTTP endpoint for you to pass to `cr_schedule()`:
