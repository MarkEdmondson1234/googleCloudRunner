...
You need to add the domain of where the Cloud Run is running in the JavaScript origins within the GCP console, that you get after deploying the app.  In the example case this is `https://shiny-cloudrun-sc-ewjogewawq-ew.a.run.app/`
