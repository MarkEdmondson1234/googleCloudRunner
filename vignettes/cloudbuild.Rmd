...
4. You should see successful builds and can check the status of the last build via `cr_build_logs_last()` which downloads the last build of the given build trigger:

```r
cr_build_logs_last("targets-scheduled-demo")
