...
vignette: >
  %\VignetteIndexEntry{Scheduled R scripts via Cloud Scheduler}
...
The first method is for lots of files in a folder that you upload:
...
gcs_source <- cr_build_upload_gcs("local_folder_containing_r_script")
