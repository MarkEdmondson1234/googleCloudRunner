...
Once you get all green ticks in `cr_setup()` then you should be able to run the subset of the package unit tests via `cr_setup_tests()`.  Should those all complete then you should be able to run any of the functions in the package!
