    ...
    Output
      ...
      - name: gcr.io/google.com/cloudsdktool/cloud-sdk:alpine
        ...
        - mkdir /workspace/_targets && mkdir /workspace/_targets/meta && gsutil -m cp -r
          gs://mark-edmondson-public-files/cr_build_target_tests/_targets/meta /workspace/_targets
          || exit 0
...
---
    ...
    Output
      ...
      args:
      - -c
      - mkdir /workspace/_targets && mkdir /workspace/_targets/meta && gsutil -m cp -r gs://mark-edmondson-public-files/cr_build_target_tests_multi/_targets/meta
...
---
    ...
    Output
      ...
      - name: gcr.io/google.com/cloudsdktool/cloud-sdk:alpine
        ...
        - -c
        - mkdir /workspace/_targets && mkdir /workspace/_targets/meta && gsutil -m cp -r
          gs://mark-edmondson-public-files/cr_build_target_tests_multi/_targets/meta /workspace/_targets
          || exit 0
        id: get previous _targets metadata
      - name: gcr.io/gcer-public/targets
        args:
